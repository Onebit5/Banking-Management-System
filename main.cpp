...
class Bank {
private:
	string userDetails[1000][5]; // Name, age, contact number, pin
	int accountsAvailable = 1000, temporaryAccountNumber = 0, accountDetails[1000][4]; //Sl no. account number, alance, last transaction 
